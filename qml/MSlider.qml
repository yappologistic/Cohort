...
Slider {
    ...
    ToolTip {
        ...
        y: -height - 12
        padding: 8
        contentItem: CohortText { objectName: "sliderValueText"; text: slider.valueLabel; color: Theme.inverseSurfaceText; font.pixelSize: Theme.labelLarge; labelRole: true }
