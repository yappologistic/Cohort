    ...
    contentItem: Item {
        ...
        Row {
            ...
            Item {
                ...
                Icon { anchors.centerIn: parent; name: control.symbol; fill: control.selected ? 1 : 0; ink: control.selected ? Theme.secondaryContainerText : Theme.muted; Accessible.ignored: true }
            }
            CohortText {
