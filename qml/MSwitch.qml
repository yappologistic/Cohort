...
Switch {
    ...
    indicator: Rectangle {
        ...
        Rectangle {
            ...
            // SwitchTokens.Selected{Hover,Focus,Pressed}HandleColor is the
            // primary container and Unselected{...}HandleColor the variant
            // ink: the handle answers the pointer as well as the state layer.
            readonly property bool engaged: control.down || control.hovered || control.visualFocus
    ...
    contentItem: CohortText { id:label;opacity: control.dimmed ? Theme.disabledContentOpacity : 1;text: control.text;rightPadding:68;verticalAlignment:Text.AlignVCenter;wrapMode:Text.Wrap;font.pixelSize:Theme.bodyLarge }
    Loader {
