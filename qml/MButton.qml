...
AbstractButton {
    ...
    // Work this button started and is waiting on. The glyph gives way to a
    // progress indicator and the button stays live-looking but inert.
    ...
    Accessible.name: tip
    Accessible.description: busy ? "Working" : ""
    Loader {
        id: tooltipLoader
    ...
    contentItem: Item {
        ...
        Row {
            ...
            Item {
                ...
                Icon { anchors.centerIn: parent; size: control.sizedIcon; besideText: control.text.length ? control.labelSize : 0; visible: !control.busy; name: control.symbol; ink: control.ink
