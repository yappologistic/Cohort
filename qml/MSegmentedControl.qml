        ...
        AbstractButton {
            ...
            contentItem: Item {
                Row {
                    ...
                    CohortText { text: button.text; font.pixelSize: Theme.labelLarge; font.weight: Font.Medium; color: button.selected ? Theme.primaryText : Theme.muted; elide: Text.ElideRight; width: Math.min(implicitWidth, button.width-24) }
                }
            }
            Rectangle {
